...
namespace My_PracticeWork.Controllers
{
    ...
    {
        Users_Work db;
        public UsersController(Users_Work context)
        {
            db = context;
            if (!db.Users.Any())
            {
                db.Users.Add(new Person { Name = "Daniil", Surname = "Malygin", Middle_Name = "Alexandrovich", 
                    Birth_Year = 2002, Birth_Month = 3, Birth_Day = 14 });
                db.SaveChanges();
            }
        }
        [HttpGet]
